    ...
    grunt.initConfig({
        ...
        mocha: {
            all: {
                options: {
                    run: true,
                    urls: ['http://<%= connect.test.options.hostname %>:<%= connect.test.options.port %>/index_old.html']
                }
            }
        },
        ...
        useminPrepare: {
            ...
            html: '<%= config.app %>/index_old.html'
        },
        ...
        usebanner: {
            html: {
                ...
                files: {
                    src: '<%= config.dist %>/index_old.html'
                }
            },
            other: {
                options: {
        ...
        // By default, your `index_old.html`'s <!-- Usemin block --> will take care of
